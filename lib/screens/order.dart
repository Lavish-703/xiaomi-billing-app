...
//import 'package:xiaomi/order.dart';
  ...
  Widget _okButton(BuildContext context) {
    ...
    final button = ElevatedButton(
      onPressed: () async {
        ...
        String text = "ProductID ${_nameControllers[index].text}\n" +
  ...
  Widget build(BuildContext context) {
    ...
    home: Scaffold(
      appBar: AppBar(
        ...
        body: Padding(//child: Text("Center Title Demo"),
...
class _View2State extends State<_View2> {
  ...
  @override
  void dispose() {
    controllerMap.forEach((, controller) => controller.dispose());
    super.dispose();
  }
